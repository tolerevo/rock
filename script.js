...
resultsMessage.setAttribute("style", "font-size: 22px; font-weight: bold; justify-content: center; line-height: 1.5; text-align: center; color: white;");
  ...
  buttons.forEach((button) => {
    ...
    button.addEventListener("click", () => {
      ...
      if (!div.classList.contains("display-results")) {
        ...
        div.setAttribute("style", "display: block; width: 100wh; height: 400px; background-color: #169FFF; padding: 5px; border-radius: 5px; justify-content: center; margin: 20px 10px; padding: 10px;");
      }
